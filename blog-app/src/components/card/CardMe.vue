<template>
  <el-card>
    <h1 class="me-author-name">张诗笛のBlog</h1>
    <div class="me-author-description">
      <span><i class="el-icon-location-outline"></i> &nbsp;浙江&杭州</span>
      <span><i class="me-icon-job"></i> &nbsp;java练习生</span>
    </div>
...
<script>
  export default {
    ...
    data() {
      return {
        qq: {title: 'QQ', message: '1006059788'},
        bilibili: {
          title: '哔哩哔哩',
          message: '<a target="_blank" href="https://space.bilibili.com/272378613?spm_id_from=333.788.0.0">https://space.bilibili.com/473844125</a>'
        }
      }
    },
    methods: {
